...
export type EngineName = PG.GameDefinition["engine"] | Judge.GameDefinition["engine"] | Quip.GameDefinition["engine"] | MITM.GameDefinition["engine"] | GroupThink.GameDefinition["engine"]; // | ...
...
export type GameDefinition = GameDefBase & (PG.GameDefinition | Judge.GameDefinition | Quip.GameDefinition | MITM.GameDefinition | GroupThink.GameDefinition); // | ...
...
type GroupThinkEngine = Engine<GroupThink.GameDefinition, GroupThink.Room, GroupThink.Message>

type GameEngine = PromptGuessEngine | JudgeEngine | QuipEngine | MITMEngine | GroupThinkEngine; // | AnotherEngine
export const engines:Record<EngineName, GameEngine> = {
  "PromptGuess": PG.engine,
  "AIJudge": Judge.engine,
  "Quip": Quip.engine,
  "MITM": MITM.engine,
  "GroupThink": GroupThink.engine,
}
